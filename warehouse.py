...
if __name__ == '__main__':
    ...
    # exit(0)
    covid_df = pandas.read_csv('F:\myStuff\数据\疫情数据\最新上海疫情数据_20220921190302.csv', engine='python', skip_blank_lines=True, encoding='utf-8',
                               parse_dates=['date'])
    ...
    site_df.to_csv('F:\myStuff\数据\疫情场景数据\site_with_covid_info_v2.csv', index=False)
    exit(0)
